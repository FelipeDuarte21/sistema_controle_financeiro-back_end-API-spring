# API RESTFull Sistema de Controle Financeiro
...
## Baixando E Instalando a API Localmente
Primeiramente tenha instalado em sua máquina: JDK 16.0.1, IDE Eclipse, PostgreSql e o Postman. Depois de tudo instalado encontre o arquivo script_db_api.sql na raiz do diretório do projeto e rode o script no PostgreSql isto é para criar o banco de dados primeiramente, em seguida clone o repositório em algum lugar na sua máquina, abra a IDE Eclipse e importe o projeto como projeto maven (pode demorar um pouco pois a IDE baixa as dependências) em seguida vá até onde está o projeto na IDE em Package Explorer clique com o botão direito do mouse em cima do projeto e RUN AS -> Spring boot application a partir daí o servidor tentará subir a API, se aparacer a mensagem "started on port(s):8080" o servidor subiu a API com sucesso. Com o Postman vc pode utilizar para fazer chamadas a API.
